...
<body>
    <div class="tip-message">
        ...
        <p class="tip-text" style="display:inline-block;width:90%;"><span class="mr5">138****1239</span>成功邀请一位好友注册 +<span>1</span>元&nbsp;&nbsp;累计赚<span>10</span>元</p>
    </div>
    ...
    <div class="withdraw-detail">
        ...
        <b>待提现</b>
        <b>¥88</b>
        <a class="blue-btn" style="text-align:center;margin:6% auto 8% auto;">确认提现</a>
        <a class="f-blue">奖励明细 ></a>
        <p>已成功邀请<span>32</span>人</p>
        <p>累计赚得现金<span>112</span>元</p>
    </div>
