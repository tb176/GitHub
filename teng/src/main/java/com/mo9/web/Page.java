...
public class Page<T> {
	...
	public static void setPageResult(Page page, List list){
		int startIdx = page.getFirst() - 1;
		int endIdx = startIdx + page.getPageSize() - 1;
		if(list != null && list.size() > 0){
			endIdx = endIdx > list.size() - 1 ? list.size() - 1 : endIdx;
			page.setResult(list.subList(startIdx, endIdx + 1));
